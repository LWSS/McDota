...
static const char* Order2String( DotaUnitOrder_t order )
{
    // r12
    switch( order ){
        CASE_STRING( DOTA_UNIT_ORDER_NONE );
        CASE_STRING( DOTA_UNIT_ORDER_MOVE_TO_POSITION );
        CASE_STRING( DOTA_UNIT_ORDER_MOVE_TO_TARGET );
        CASE_STRING( DOTA_UNIT_ORDER_ATTACK_MOVE );
        CASE_STRING( DOTA_UNIT_ORDER_ATTACK_TARGET );
        CASE_STRING( DOTA_UNIT_ORDER_CAST_POSITION );
        CASE_STRING( DOTA_UNIT_ORDER_CAST_TARGET );
        CASE_STRING( DOTA_UNIT_ORDER_CAST_TARGET_TREE );
        CASE_STRING( DOTA_UNIT_ORDER_CAST_NO_TARGET );
        CASE_STRING( DOTA_UNIT_ORDER_CAST_TOGGLE );
        CASE_STRING( DOTA_UNIT_ORDER_HOLD_POSITION  );
        CASE_STRING( DOTA_UNIT_ORDER_TRAIN_ABILITY  );
        CASE_STRING( DOTA_UNIT_ORDER_DROP_ITEM  );
        CASE_STRING( DOTA_UNIT_ORDER_GIVE_ITEM  );
        CASE_STRING( DOTA_UNIT_ORDER_PICKUP_ITEM  );
        CASE_STRING( DOTA_UNIT_ORDER_PICKUP_RUNE  );
        CASE_STRING( DOTA_UNIT_ORDER_PURCHASE_ITEM  );
        CASE_STRING( DOTA_UNIT_ORDER_SELL_ITEM  );
        CASE_STRING( DOTA_UNIT_ORDER_DISASSEMBLE_ITEM  );
        CASE_STRING( DOTA_UNIT_ORDER_MOVE_ITEM  );
        CASE_STRING( DOTA_UNIT_ORDER_CAST_TOGGLE_AUTO  );
        CASE_STRING( DOTA_UNIT_ORDER_STOP  );
        CASE_STRING( DOTA_UNIT_ORDER_TAUNT  );
        CASE_STRING( DOTA_UNIT_ORDER_BUYBACK  );
        CASE_STRING( DOTA_UNIT_ORDER_GLYPH  );
        CASE_STRING( DOTA_UNIT_ORDER_EJECT_ITEM_FROM_STASH  );
        CASE_STRING( DOTA_UNIT_ORDER_CAST_RUNE  );
        CASE_STRING( DOTA_UNIT_ORDER_PING_ABILITY  );
        CASE_STRING( DOTA_UNIT_ORDER_MOVE_TO_DIRECTION  );
        CASE_STRING( DOTA_UNIT_ORDER_PATROL  );
        CASE_STRING( DOTA_UNIT_ORDER_VECTOR_TARGET_POSITION  );
        CASE_STRING( DOTA_UNIT_ORDER_RADAR  );
        CASE_STRING( DOTA_UNIT_ORDER_SET_ITEM_COMBINE_LOCK  );
        CASE_STRING( DOTA_UNIT_ORDER_CONTINUE  );
        CASE_STRING( DOTA_UNIT_ORDER_VECTOR_TARGET_CANCELED  );
        CASE_STRING( DOTA_UNIT_ORDER_CAST_RIVER_PAINT  );
        CASE_STRING( DOTA_UNIT_ORDER_PREGAME_ADJUST_ITEM_ASSIGNMENT  );
        default:
