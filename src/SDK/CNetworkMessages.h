...
{
    switch( msg ){
        CASE_STRING(k_EMsgGCDOTABase);
        CASE_STRING(k_EMsgGCGeneralResponse);
        CASE_STRING(k_EMsgGCGameMatchSignOut);
        CASE_STRING(k_EMsgGCGameMatchSignOutResponse);
        CASE_STRING(k_EMsgGCJoinChatChannel);
        CASE_STRING(k_EMsgGCJoinChatChannelResponse);
        CASE_STRING(k_EMsgGCOtherJoinedChannel);
        CASE_STRING(k_EMsgGCOtherLeftChannel);
        CASE_STRING(k_EMsgGCMatchHistoryList);
        CASE_STRING(k_EMsgServerToGCRequestStatus);
        CASE_STRING(k_EMsgGCGetRecentMatches);
        CASE_STRING(k_EMsgGCRecentMatchesResponse);
        CASE_STRING(k_EMsgGCStartFindingMatch);
        CASE_STRING(k_EMsgGCConnectedPlayers);
        CASE_STRING(k_EMsgGCAbandonCurrentGame);
        CASE_STRING(k_EMsgGCStopFindingMatch);
        CASE_STRING(k_EMsgGCPracticeLobbyCreate);
        CASE_STRING(k_EMsgGCPracticeLobbyLeave);
        CASE_STRING(k_EMsgGCPracticeLobbyLaunch);
        CASE_STRING(k_EMsgGCPracticeLobbyList);
        CASE_STRING(k_EMsgGCPracticeLobbyListResponse);
        CASE_STRING(k_EMsgGCPracticeLobbyJoin);
        CASE_STRING(k_EMsgGCPracticeLobbySetDetails);
        CASE_STRING(k_EMsgGCPracticeLobbySetTeamSlot);
        CASE_STRING(k_EMsgGCInitialQuestionnaireResponse);
        CASE_STRING(k_EMsgGCPracticeLobbyResponse);
        CASE_STRING(k_EMsgGCBroadcastNotification);
        CASE_STRING(k_EMsgGCLiveScoreboardUpdate);
        CASE_STRING(k_EMsgGCRequestChatChannelList);
        CASE_STRING(k_EMsgGCRequestChatChannelListResponse);
        CASE_STRING(k_EMsgGCRequestMatches);
        CASE_STRING(k_EMsgGCRequestMatchesResponse);
        CASE_STRING(k_EMsgGCRequestPlayerResources);
        CASE_STRING(k_EMsgGCRequestPlayerResourcesResponse);
        CASE_STRING(k_EMsgGCReadyUp);
        CASE_STRING(k_EMsgGCKickedFromMatchmakingQueue);
        CASE_STRING(k_EMsgGCLeaverDetected);
        CASE_STRING(k_EMsgGCSpectateFriendGame);
        CASE_STRING(k_EMsgGCSpectateFriendGameResponse);
        CASE_STRING(k_EMsgGCPlayerReports);
        CASE_STRING(k_EMsgGCReportsRemainingRequest);
        CASE_STRING(k_EMsgGCReportsRemainingResponse);
        CASE_STRING(k_EMsgGCSubmitPlayerReport);
        CASE_STRING(k_EMsgGCSubmitPlayerReportResponse);
        CASE_STRING(k_EMsgGCPracticeLobbyKick);
        CASE_STRING(k_EMsgGCReportCountsRequest);
        CASE_STRING(k_EMsgGCReportCountsResponse);
        CASE_STRING(k_EMsgGCRequestSaveGames);
        CASE_STRING(k_EMsgGCRequestSaveGamesServer);
        CASE_STRING(k_EMsgGCRequestSaveGamesResponse);
        CASE_STRING(k_EMsgGCLeaverDetectedResponse);
        CASE_STRING(k_EMsgGCPlayerFailedToConnect);
        CASE_STRING(k_EMsgGCGCToRelayConnect);
        CASE_STRING(k_EMsgGCGCToRelayConnectresponse);
        CASE_STRING(k_EMsgGCWatchGame);
        CASE_STRING(k_EMsgGCWatchGameResponse);
        CASE_STRING(k_EMsgGCBanStatusRequest);
        CASE_STRING(k_EMsgGCBanStatusResponse);
        CASE_STRING(k_EMsgGCMatchDetailsRequest);
        CASE_STRING(k_EMsgGCMatchDetailsResponse);
        CASE_STRING(k_EMsgGCCancelWatchGame);
        CASE_STRING(k_EMsgGCPopup);
        CASE_STRING(k_EMsgGCDOTAClearNotifySuccessfulReport);
        CASE_STRING(k_EMsgGCFriendPracticeLobbyListRequest);
        CASE_STRING(k_EMsgGCFriendPracticeLobbyListResponse);
        CASE_STRING(k_EMsgGCPracticeLobbyJoinResponse);
        CASE_STRING(k_EMsgClientEconNotification_Job);
        CASE_STRING(k_EMsgGCCreateTeam);
        CASE_STRING(k_EMsgGCCreateTeamResponse);
        CASE_STRING(k_EMsgGCTeamData);
        CASE_STRING(k_EMsgGCTeamInvite_InviterToGC);
        CASE_STRING(k_EMsgGCTeamInvite_GCImmediateResponseToInviter);
        CASE_STRING(k_EMsgGCTeamInvite_GCRequestToInvitee);
        CASE_STRING(k_EMsgGCTeamInvite_InviteeResponseToGC);
        CASE_STRING(k_EMsgGCTeamInvite_GCResponseToInviter);
        CASE_STRING(k_EMsgGCTeamInvite_GCResponseToInvitee);
        CASE_STRING(k_EMsgGCKickTeamMember);
        CASE_STRING(k_EMsgGCKickTeamMemberResponse);
        CASE_STRING(k_EMsgGCLeaveTeam);
        CASE_STRING(k_EMsgGCLeaveTeamResponse);
        CASE_STRING(k_EMsgGCSuggestTeamMatchmaking);
        CASE_STRING(k_EMsgGCPlayerHeroesFavoritesAdd);
        CASE_STRING(k_EMsgGCPlayerHeroesFavoritesRemove);
        CASE_STRING(k_EMsgGCApplyTeamToPracticeLobby);
        CASE_STRING(k_EMsgGCTransferTeamAdmin);
        CASE_STRING(k_EMsgGCPracticeLobbyJoinBroadcastChannel);
        CASE_STRING(k_EMsgGC_TournamentItemEvent);
        CASE_STRING(k_EMsgGC_TournamentItemEventResponse);
        CASE_STRING(k_EMsgCastMatchVote);
        CASE_STRING(k_EMsgCastMatchVoteResponse);
        CASE_STRING(k_EMsgRetrieveMatchVote);
        CASE_STRING(k_EMsgRetrieveMatchVoteResponse);
        CASE_STRING(k_EMsgTeamFanfare);
        CASE_STRING(k_EMsgResponseTeamFanfare);
        CASE_STRING(k_EMsgGC_GameServerUploadSaveGame);
        CASE_STRING(k_EMsgGC_GameServerSaveGameResult);
        CASE_STRING(k_EMsgGC_GameServerGetLoadGame);
        CASE_STRING(k_EMsgGC_GameServerGetLoadGameResult);
        CASE_STRING(k_EMsgGCEditTeamDetails);
        CASE_STRING(k_EMsgGCEditTeamDetailsResponse);
        CASE_STRING(k_EMsgGCProTeamListRequest);
        CASE_STRING(k_EMsgGCProTeamListResponse);
        CASE_STRING(k_EMsgGCReadyUpStatus);
        CASE_STRING(k_EMsgGCHallOfFame);
        CASE_STRING(k_EMsgGCHallOfFameRequest);
        CASE_STRING(k_EMsgGCHallOfFameResponse);
        CASE_STRING(k_EMsgGCGenerateDiretidePrizeList);
        CASE_STRING(k_EMsgGCRewardDiretidePrizes);
        CASE_STRING(k_EMsgGCDiretidePrizesRewardedResponse);
        CASE_STRING(k_EMsgGCHalloweenHighScoreRequest);
        CASE_STRING(k_EMsgGCHalloweenHighScoreResponse);
        CASE_STRING(k_EMsgGCGenerateDiretidePrizeListResponse);
        CASE_STRING(k_EMsgGCStorePromoPagesRequest);
        CASE_STRING(k_EMsgGCStorePromoPagesResponse);
        CASE_STRING(k_EMsgGCToGCMatchCompleted);
        CASE_STRING(k_EMsgGCBalancedShuffleLobby);
        CASE_STRING(k_EMsgGCToGCCheckLeaguePermission);
        CASE_STRING(k_EMsgGCToGCCheckLeaguePermissionResponse);
        CASE_STRING(k_EMsgGCMatchmakingStatsRequest);
        CASE_STRING(k_EMsgGCMatchmakingStatsResponse);
        CASE_STRING(k_EMsgGCBotGameCreate);
        CASE_STRING(k_EMsgGCSetMatchHistoryAccess);
        CASE_STRING(k_EMsgGCSetMatchHistoryAccessResponse);
        CASE_STRING(k_EMsgUpgradeLeagueItem);
        CASE_STRING(k_EMsgUpgradeLeagueItemResponse);
        CASE_STRING(k_EMsgGCTeamMemberProfileRequest);
        CASE_STRING(k_EMsgGCWatchDownloadedReplay);
        CASE_STRING(k_EMsgGCSetMapLocationState);
        CASE_STRING(k_EMsgGCSetMapLocationStateResponse);
        CASE_STRING(k_EMsgGCResetMapLocations);
        CASE_STRING(k_EMsgGCResetMapLocationsResponse);
        CASE_STRING(k_EMsgRefreshPartnerAccountLink);
        CASE_STRING(k_EMsgClientsRejoinChatChannels);
        CASE_STRING(k_EMsgGCToGCGetUserChatInfo);
        CASE_STRING(k_EMsgGCToGCGetUserChatInfoResponse);
        CASE_STRING(k_EMsgGCToGCLeaveAllChatChannels);
        CASE_STRING(k_EMsgGCToGCUpdateAccountChatBan);
        CASE_STRING(k_EMsgGCGuildCreateRequest);
        CASE_STRING(k_EMsgGCGuildCreateResponse);
        CASE_STRING(k_EMsgGCGuildSetAccountRoleRequest);
        CASE_STRING(k_EMsgGCGuildSetAccountRoleResponse);
        CASE_STRING(k_EMsgGCRequestGuildData);
        CASE_STRING(k_EMsgGCGuildData);
        CASE_STRING(k_EMsgGCGuildInviteAccountRequest);
        CASE_STRING(k_EMsgGCGuildInviteAccountResponse);
        CASE_STRING(k_EMsgGCGuildCancelInviteRequest);
        CASE_STRING(k_EMsgGCGuildCancelInviteResponse);
        CASE_STRING(k_EMsgGCGuildUpdateDetailsRequest);
        CASE_STRING(k_EMsgGCGuildUpdateDetailsResponse);
        CASE_STRING(k_EMsgGCToGCCanInviteUserToTeam);
        CASE_STRING(k_EMsgGCToGCCanInviteUserToTeamResponse);
        CASE_STRING(k_EMsgGCToGCGetUserRank);
        CASE_STRING(k_EMsgGCToGCGetUserRankResponse);
        CASE_STRING(k_EMsgGCToGCUpdateTeamStats);
        CASE_STRING(k_EMsgGCToGCValidateTeam);
        CASE_STRING(k_EMsgGCToGCValidateTeamResponse);
        CASE_STRING(k_EMsgGCPassportDataRequest);
        CASE_STRING(k_EMsgGCPassportDataResponse);
        CASE_STRING(k_EMsgGCNotInGuildData);
        CASE_STRING(k_EMsgGCGuildInviteData);
        CASE_STRING(k_EMsgGCToGCGetLeagueAdmin);
        CASE_STRING(k_EMsgGCToGCGetLeagueAdminResponse);
        CASE_STRING(k_EMsgGCRequestLeaguePrizePool);
        CASE_STRING(k_EMsgGCRequestLeaguePrizePoolResponse);
        CASE_STRING(k_EMsgGCToGCUpdateOpenGuildPartyRequest);
        CASE_STRING(k_EMsgGCToGCUpdateOpenGuildPartyResponse);
        CASE_STRING(k_EMsgGCToGCDestroyOpenGuildPartyRequest);
        CASE_STRING(k_EMsgGCToGCDestroyOpenGuildPartyResponse);
        CASE_STRING(k_EMsgGCGuildUpdateMessage);
        CASE_STRING(k_EMsgGCPartySetOpenGuildRequest);
        CASE_STRING(k_EMsgGCPartySetOpenGuildResponse);
        CASE_STRING(k_EMsgGCGuildOpenPartyRefresh);
        CASE_STRING(k_EMsgGCJoinOpenGuildPartyRequest);
        CASE_STRING(k_EMsgGCJoinOpenGuildPartyResponse);
        CASE_STRING(k_EMsgGCLeaveChatChannel);
        CASE_STRING(k_EMsgGCChatMessage);
        CASE_STRING(k_EMsgGCGetHeroStandings);
        CASE_STRING(k_EMsgGCGetHeroStandingsResponse);
        CASE_STRING(k_EMsgGCGuildEditLogoRequest);
        CASE_STRING(k_EMsgGCGuildEditLogoResponse);
        CASE_STRING(k_EMsgGCGuildmatePracticeLobbyListRequest);
        CASE_STRING(k_EMsgGCGuildmatePracticeLobbyListResponse);
        CASE_STRING(k_EMsgGCItemEditorReservationsRequest);
        CASE_STRING(k_EMsgGCItemEditorReservationsResponse);
        CASE_STRING(k_EMsgGCItemEditorReserveItemDef);
        CASE_STRING(k_EMsgGCItemEditorReserveItemDefResponse);
        CASE_STRING(k_EMsgGCItemEditorReleaseReservation);
        CASE_STRING(k_EMsgGCItemEditorReleaseReservationResponse);
        CASE_STRING(k_EMsgGCRewardTutorialPrizes);
        CASE_STRING(k_EMsgGCLastHitChallengeHighScorePost);
        CASE_STRING(k_EMsgGCLastHitChallengeHighScoreRequest);
        CASE_STRING(k_EMsgGCLastHitChallengeHighScoreResponse);
        CASE_STRING(k_EMsgGCCreateFantasyLeagueRequest);
        CASE_STRING(k_EMsgGCCreateFantasyLeagueResponse);
        CASE_STRING(k_EMsgGCFantasyLeagueInfoRequest);
        CASE_STRING(k_EMsgGCFantasyLeagueInfoResponse);
        CASE_STRING(k_EMsgGCFantasyLeagueInfo);
        CASE_STRING(k_EMsgGCCreateFantasyTeamRequest);
        CASE_STRING(k_EMsgGCCreateFantasyTeamResponse);
        CASE_STRING(k_EMsgGCEditFantasyTeamRequest);
        CASE_STRING(k_EMsgGCEditFantasyTeamResponse);
        CASE_STRING(k_EMsgGCFantasyTeamInfoRequestByFantasyLeagueID);
        CASE_STRING(k_EMsgGCFantasyTeamInfoRequestByOwnerAccountID);
        CASE_STRING(k_EMsgGCFantasyTeamInfoResponse);
        CASE_STRING(k_EMsgGCFantasyTeamInfo);
        CASE_STRING(k_EMsgGCFantasyLivePlayerStats);
        CASE_STRING(k_EMsgGCFantasyFinalPlayerStats);
        CASE_STRING(k_EMsgGCFantasyMatch);
        CASE_STRING(k_EMsgGCFantasyTeamScoreRequest);
        CASE_STRING(k_EMsgGCFantasyTeamScoreResponse);
        CASE_STRING(k_EMsgGCFantasyTeamStandingsRequest);
        CASE_STRING(k_EMsgGCFantasyTeamStandingsResponse);
        CASE_STRING(k_EMsgGCFantasyPlayerScoreRequest);
        CASE_STRING(k_EMsgGCFantasyPlayerScoreResponse);
        CASE_STRING(k_EMsgGCFantasyPlayerStandingsRequest);
        CASE_STRING(k_EMsgGCFantasyPlayerStandingsResponse);
        CASE_STRING(k_EMsgGCFlipLobbyTeams);
        CASE_STRING(k_EMsgGCCustomGameCreate);
        CASE_STRING(k_EMsgGCToGCProcessPlayerReportForTarget);
        CASE_STRING(k_EMsgGCToGCProcessReportSuccess);
        CASE_STRING(k_EMsgGCNotifyAccountFlagsChange);
        CASE_STRING(k_EMsgGCSetProfilePrivacy);
        CASE_STRING(k_EMsgGCSetProfilePrivacyResponse);
        CASE_STRING(k_EMsgGCFantasyLeagueCreateInfoRequest);
        CASE_STRING(k_EMsgGCFantasyLeagueCreateInfoResponse);
        CASE_STRING(k_EMsgGCFantasyLeagueInviteInfoRequest);
        CASE_STRING(k_EMsgGCFantasyLeagueInviteInfoResponse);
        CASE_STRING(k_EMsgGCClientIgnoredUser);
        CASE_STRING(k_EMsgGCFantasyLeagueCreateRequest);
        CASE_STRING(k_EMsgGCFantasyLeagueCreateResponse);
        CASE_STRING(k_EMsgGCFantasyTeamCreateRequest);
        CASE_STRING(k_EMsgGCFantasyTeamCreateResponse);
        CASE_STRING(k_EMsgGCFantasyLeagueFriendJoinListRequest);
        CASE_STRING(k_EMsgGCFantasyLeagueFriendJoinListResponse);
        CASE_STRING(k_EMsgGCClientSuspended);
        CASE_STRING(k_EMsgGCPartyMemberSetCoach);
        CASE_STRING(k_EMsgGCFantasyLeagueEditInvitesRequest);
        CASE_STRING(k_EMsgGCFantasyLeagueEditInvitesResponse);
        CASE_STRING(k_EMsgGCPracticeLobbySetCoach);
        CASE_STRING(k_EMsgGCFantasyLeagueEditInfoRequest);
        CASE_STRING(k_EMsgGCFantasyLeagueEditInfoResponse);
        CASE_STRING(k_EMsgGCFantasyLeagueDraftStatusRequest);
        CASE_STRING(k_EMsgGCFantasyLeagueDraftStatus);
        CASE_STRING(k_EMsgGCFantasyLeagueDraftPlayerRequest);
        CASE_STRING(k_EMsgGCFantasyLeagueDraftPlayerResponse);
        CASE_STRING(k_EMsgGCFantasyLeagueMatchupsRequest);
        CASE_STRING(k_EMsgGCFantasyLeagueMatchupsResponse);
        CASE_STRING(k_EMsgGCFantasyTeamRosterSwapRequest);
        CASE_STRING(k_EMsgGCFantasyTeamRosterSwapResponse);
        CASE_STRING(k_EMsgGCFantasyTeamRosterRequest);
        CASE_STRING(k_EMsgGCFantasyTeamRosterResponse);
        CASE_STRING(k_EMsgGCFantasyTeamRosterAddDropRequest);
        CASE_STRING(k_EMsgGCFantasyTeamRosterAddDropResponse);
        CASE_STRING(k_EMsgPresentedClientTerminateDlg);
        CASE_STRING(k_EMsgGCFantasyPlayerHisoricalStatsRequest);
        CASE_STRING(k_EMsgGCFantasyPlayerHisoricalStatsResponse);
        CASE_STRING(k_EMsgGCPCBangTimedRewardMessage);
        CASE_STRING(k_EMsgGCLobbyUpdateBroadcastChannelInfo);
        CASE_STRING(k_EMsgGCFantasyTeamTradesRequest);
        CASE_STRING(k_EMsgGCFantasyTeamTradesResponse);
        CASE_STRING(k_EMsgGCFantasyTeamTradeCancelRequest);
        CASE_STRING(k_EMsgGCFantasyTeamTradeCancelResponse);
        CASE_STRING(k_EMsgGCToGCGrantTournamentItem);
        CASE_STRING(k_EMsgGCProcessFantasyScheduledEvent);
        CASE_STRING(k_EMsgGCToGCUpgradeTwitchViewerItems);
        CASE_STRING(k_EMsgGCToGCGetLiveMatchAffiliates);
        CASE_STRING(k_EMsgGCToGCGetLiveMatchAffiliatesResponse);
        CASE_STRING(k_EMsgGCToGCUpdatePlayerPennantCounts);
        CASE_STRING(k_EMsgGCToGCGetPlayerPennantCounts);
        CASE_STRING(k_EMsgGCToGCGetPlayerPennantCountsResponse);
        CASE_STRING(k_EMsgGCGameMatchSignOutPermissionRequest);
        CASE_STRING(k_EMsgGCGameMatchSignOutPermissionResponse);
        CASE_STRING(k_EMsgDOTAChatChannelMemberUpdate);
        CASE_STRING(k_EMsgDOTAAwardEventPoints);
        CASE_STRING(k_EMsgDOTAGetEventPoints);
        CASE_STRING(k_EMsgDOTAGetEventPointsResponse);
        CASE_STRING(k_EMsgDOTASendFriendRecruits);
        CASE_STRING(k_EMsgDOTAFriendRecruitsRequest);
        CASE_STRING(k_EMsgDOTAFriendRecruitsResponse);
        CASE_STRING(k_EMsgDOTAFriendRecruitInviteAcceptDecline);
        CASE_STRING(k_EMsgGCPartyLeaderWatchGamePrompt);
        CASE_STRING(k_EMsgDOTAFrostivusTimeElapsed);
        CASE_STRING(k_EMsgDOTALiveLeagueGameUpdate);
        CASE_STRING(k_EMsgDOTAChatGetUserList);
        CASE_STRING(k_EMsgDOTAChatGetUserListResponse);
        CASE_STRING(k_EMsgGCCompendiumSetSelection);
        CASE_STRING(k_EMsgGCCompendiumDataRequest);
        CASE_STRING(k_EMsgGCCompendiumDataResponse);
        CASE_STRING(k_EMsgDOTAGetPlayerMatchHistory);
        CASE_STRING(k_EMsgDOTAGetPlayerMatchHistoryResponse);
        CASE_STRING(k_EMsgGCToGCMatchmakingAddParty);
        CASE_STRING(k_EMsgGCToGCMatchmakingRemoveParty);
        CASE_STRING(k_EMsgGCToGCMatchmakingRemoveAllParties);
        CASE_STRING(k_EMsgGCToGCMatchmakingMatchFound);
        CASE_STRING(k_EMsgGCToGCUpdateMatchManagementStats);
        CASE_STRING(k_EMsgGCToGCUpdateMatchmakingStats);
        CASE_STRING(k_EMsgGCToServerPingRequest);
        CASE_STRING(k_EMsgGCToServerPingResponse);
        CASE_STRING(k_EMsgGCToServerConsoleCommand);
        CASE_STRING(k_EMsgGCMakeOffering);
        CASE_STRING(k_EMsgGCRequestOfferings);
        CASE_STRING(k_EMsgGCRequestOfferingsResponse);
        CASE_STRING(k_EMsgGCToGCProcessMatchLeaver);
        CASE_STRING(k_EMsgGCNotificationsRequest);
        CASE_STRING(k_EMsgGCNotificationsResponse);
        CASE_STRING(k_EMsgGCToGCModifyNotification);
        CASE_STRING(k_EMsgGCToGCSetNewNotifications);
        CASE_STRING(k_EMsgGCLeagueAdminList);
        CASE_STRING(k_EMsgGCNotificationsMarkReadRequest);
        CASE_STRING(k_EMsgGCFantasyMessageAdd);
        CASE_STRING(k_EMsgGCFantasyMessagesRequest);
        CASE_STRING(k_EMsgGCFantasyMessagesResponse);
        CASE_STRING(k_EMsgGCFantasyScheduledMatchesRequest);
        CASE_STRING(k_EMsgGCFantasyScheduledMatchesResponse);
        CASE_STRING(k_EMsgGCEventGameCreate);
        CASE_STRING(k_EMsgGCPerfectWorldUserLookupRequest);
        CASE_STRING(k_EMsgGCPerfectWorldUserLookupResponse);
        CASE_STRING(k_EMsgGCFantasyRemoveOwner);
        CASE_STRING(k_EMsgGCFantasyRemoveOwnerResponse);
        CASE_STRING(k_EMsgGCRequestBatchPlayerResources);
        CASE_STRING(k_EMsgGCRequestBatchPlayerResourcesResponse);
        CASE_STRING(k_EMsgGCToGCSendUpdateLeagues);
        CASE_STRING(k_EMsgGCCompendiumSetSelectionResponse);
        CASE_STRING(k_EMsgGCPlayerInfoRequest);
        CASE_STRING(k_EMsgGCPlayerInfo);
        CASE_STRING(k_EMsgGCPlayerInfoSubmit);
        CASE_STRING(k_EMsgGCPlayerInfoSubmitResponse);
        CASE_STRING(k_EMsgGCToGCGetAccountLevel);
        CASE_STRING(k_EMsgGCToGCGetAccountLevelResponse);
        CASE_STRING(k_EMsgGCToGCGetAccountPartner);
        CASE_STRING(k_EMsgGCToGCGetAccountPartnerResponse);
        CASE_STRING(k_EMsgDOTAGetWeekendTourneySchedule);
        CASE_STRING(k_EMsgDOTAWeekendTourneySchedule);
        CASE_STRING(k_EMsgGCJoinableCustomGameModesRequest);
        CASE_STRING(k_EMsgGCJoinableCustomGameModesResponse);
        CASE_STRING(k_EMsgGCJoinableCustomLobbiesRequest);
        CASE_STRING(k_EMsgGCJoinableCustomLobbiesResponse);
        CASE_STRING(k_EMsgGCQuickJoinCustomLobby);
        CASE_STRING(k_EMsgGCQuickJoinCustomLobbyResponse);
        CASE_STRING(k_EMsgGCToGCGrantEventPointAction);
        CASE_STRING(k_EMsgServerGrantSurveyPermission);
        CASE_STRING(k_EMsgServerGrantSurveyPermissionResponse);
        CASE_STRING(k_EMsgClientProvideSurveyResult);
        CASE_STRING(k_EMsgGCToGCSetCompendiumSelection);
        CASE_STRING(k_EMsgGCToGCUpdateTI4HeroQuest);
        CASE_STRING(k_EMsgGCCompendiumDataChanged);
        CASE_STRING(k_EMsgDOTAFantasyLeagueFindRequest);
        CASE_STRING(k_EMsgDOTAFantasyLeagueFindResponse);
        CASE_STRING(k_EMsgGCHasItemQuery);
        CASE_STRING(k_EMsgGCHasItemResponse);
        CASE_STRING(k_EMsgGCConsumeFantasyTicket);
        CASE_STRING(k_EMsgGCConsumeFantasyTicketFailure);
        CASE_STRING(k_EMsgGCToGCGrantEventPointActionMsg);
        CASE_STRING(k_EMsgClientToGCTrackDialogResult);
        CASE_STRING(k_EMsgGCFantasyLeaveLeagueRequest);
        CASE_STRING(k_EMsgGCFantasyLeaveLeagueResponse);
        CASE_STRING(k_EMsgGCToGCGetCompendiumSelections);
        CASE_STRING(k_EMsgGCToGCGetCompendiumSelectionsResponse);
        CASE_STRING(k_EMsgServerToGCMatchConnectionStats);
        CASE_STRING(k_EMsgGCToClientTournamentItemDrop);
        CASE_STRING(k_EMsgSQLDelayedGrantLeagueDrop);
        CASE_STRING(k_EMsgServerGCUpdateSpectatorCount);
        CASE_STRING(k_EMsgGCFantasyPlayerScoreDetailsRequest);
        CASE_STRING(k_EMsgGCFantasyPlayerScoreDetailsResponse);
        CASE_STRING(k_EMsgGCToGCEmoticonUnlock);
        CASE_STRING(k_EMsgSignOutDraftInfo);
        CASE_STRING(k_EMsgClientToGCEmoticonDataRequest);
        CASE_STRING(k_EMsgGCToClientEmoticonData);
        CASE_STRING(k_EMsgGCPracticeLobbyToggleBroadcastChannelCameramanStatus);
        CASE_STRING(k_EMsgGCToGCCreateWeekendTourneyRequest);
        CASE_STRING(k_EMsgGCToGCCreateWeekendTourneyResponse);
        CASE_STRING(k_EMsgClientToGCSetAdditionalEquips);
        CASE_STRING(k_EMsgClientToGCGetAdditionalEquips);
        CASE_STRING(k_EMsgClientToGCGetAdditionalEquipsResponse);
        CASE_STRING(k_EMsgServerToGCGetAdditionalEquips);
        CASE_STRING(k_EMsgServerToGCGetAdditionalEquipsResponse);
        CASE_STRING(k_EMsgDOTARedeemItem);
        CASE_STRING(k_EMsgDOTARedeemItemResponse);
        CASE_STRING(k_EMsgSQLGCToGCGrantAllHeroProgress);
        CASE_STRING(k_EMsgClientToGCGetAllHeroProgress);
        CASE_STRING(k_EMsgClientToGCGetAllHeroProgressResponse);
        CASE_STRING(k_EMsgGCToGCGetServerForClient);
        CASE_STRING(k_EMsgGCToGCGetServerForClientResponse);
        CASE_STRING(k_EMsgSQLProcessTournamentGameOutcome);
        CASE_STRING(k_EMsgSQLGrantTrophyToAccount);
        CASE_STRING(k_EMsgClientToGCGetTrophyList);
        CASE_STRING(k_EMsgClientToGCGetTrophyListResponse);
        CASE_STRING(k_EMsgGCToClientTrophyAwarded);
        CASE_STRING(k_EMsgGCGameBotMatchSignOut);
        CASE_STRING(k_EMsgGCGameBotMatchSignOutPermissionRequest);
        CASE_STRING(k_EMsgSignOutBotInfo);
        CASE_STRING(k_EMsgGCToGCUpdateProfileCards);
        CASE_STRING(k_EMsgClientToGCGetProfileCard);
        CASE_STRING(k_EMsgClientToGCGetProfileCardResponse);
        CASE_STRING(k_EMsgServerToGCGetProfileCard);
        CASE_STRING(k_EMsgServerToGCGetProfileCardResponse);
        CASE_STRING(k_EMsgClientToGCSetProfileCardSlots);
        CASE_STRING(k_EMsgGCToClientProfileCardUpdated);
        CASE_STRING(k_EMsgServerToGCVictoryPredictions);
        CASE_STRING(k_EMsgClientToGCMarkNotificationListRead);
        CASE_STRING(k_EMsgServerToGCSuspiciousActivity);
        CASE_STRING(k_EMsgSignOutCommunicationSummary);
        CASE_STRING(k_EMsgServerToGCRequestStatus_Response);
        CASE_STRING(k_EMsgClientToGCCreateHeroStatue);
        CASE_STRING(k_EMsgGCToClientHeroStatueCreateResult);
        CASE_STRING(k_EMsgGCGCToLANServerRelayConnect);
        CASE_STRING(k_EMsgServerToGCGetIngameEventData);
        CASE_STRING(k_EMsgGCToGCUpdateIngameEventDataBroadcast);
        CASE_STRING(k_EMsgGCToServerIngameEventData_OraclePA);
        CASE_STRING(k_EMsgServerToGCReportKillSummaries);
        CASE_STRING(k_EMsgGCToGCReportKillSummaries);
        CASE_STRING(k_EMsgGCToGCUpdateAssassinMinigame);
        CASE_STRING(k_EMsgGCToGCFantasySetMatchLeague);
        CASE_STRING(k_EMsgGCToGCUpdatePlayerPredictions);
        CASE_STRING(k_EMsgGCToServerPredictionResult);
        CASE_STRING(k_EMsgServerToGCSignoutAwardAdditionalDrops);
        CASE_STRING(k_EMsgGCToGCSignoutAwardAdditionalDrops);
        CASE_STRING(k_EMsgGCToClientEventStatusChanged);
        CASE_STRING(k_EMsgGCHasItemDefsQuery);
        CASE_STRING(k_EMsgGCHasItemDefsResponse);
        CASE_STRING(k_EMsgGCToGCReplayMonitorValidateReplay);
        CASE_STRING(k_EMsgLobbyEventPoints);
        CASE_STRING(k_EMsgGCToGCGetCustomGameTickets);
        CASE_STRING(k_EMsgGCToGCGetCustomGameTicketsResponse);
        CASE_STRING(k_EMsgGCToGCCustomGamePlayed);
        CASE_STRING(k_EMsgGCToGCGrantEventPointsToUser);
        CASE_STRING(k_EMsgGCToGCSetEventMMPanicFlushTime);
        CASE_STRING(k_EMsgGameserverCrashReport);
        CASE_STRING(k_EMsgGameserverCrashReportResponse);
        CASE_STRING(k_EMsgGCToClientSteamDatagramTicket);
        CASE_STRING(k_EMsgGCToGCGrantEventOwnership);
        CASE_STRING(k_EMsgGCToGCSendAccountsEventPoints);
        CASE_STRING(k_EMsgClientToGCRerollPlayerChallenge);
        CASE_STRING(k_EMsgServerToGCRerollPlayerChallenge);
        CASE_STRING(k_EMsgGCRerollPlayerChallengeResponse);
        CASE_STRING(k_EMsgSignOutUpdatePlayerChallenge);
        CASE_STRING(k_EMsgClientToGCSetPartyLeader);
        CASE_STRING(k_EMsgClientToGCCancelPartyInvites);
        CASE_STRING(k_EMsgGCToGCMasterReloadAccount);
        CASE_STRING(k_EMsgSQLGrantLeagueMatchToTicketHolders);
        CASE_STRING(k_EMsgClientToGCSetAdditionalEquipsResponse);
        CASE_STRING(k_EMsgGCToGCEmoticonUnlockNoRollback);
        CASE_STRING(k_EMsgGCToGCGetCompendiumFanfare);
        CASE_STRING(k_EMsgGCToGCChatNewUserSession);
        CASE_STRING(k_EMsgClientToGCApplyGemCombiner);
        CASE_STRING(k_EMsgClientToGCDOTACreateStaticRecipe);
        CASE_STRING(k_EMsgClientToGCDOTACreateStaticRecipeResponse);
        CASE_STRING(k_EMsgClientToGCGetAllHeroOrder);
        CASE_STRING(k_EMsgClientToGCGetAllHeroOrderResponse);
        CASE_STRING(k_EMsgSQLGCToGCGrantBadgePoints);
        CASE_STRING(k_EMsgGCToGCGetAccountMatchStatus);
        CASE_STRING(k_EMsgGCToGCGetAccountMatchStatusResponse);
        CASE_STRING(k_EMsgGCToGCCheckOwnsEntireEmoticonRange);
        CASE_STRING(k_EMsgGCToGCCheckOwnsEntireEmoticonRangeResponse);
        CASE_STRING(k_EMsgClientToGCRecycleHeroRelic);
        CASE_STRING(k_EMsgClientToGCRecycleHeroRelicResponse);
        CASE_STRING(k_EMsgGCToGCRevokeEventOwnership);
        CASE_STRING(k_EMsgGCToGCUnlockEventPointSpending);
        CASE_STRING(k_EMsgGCToClientRequestLaneSelection);
        CASE_STRING(k_EMsgGCToClientRequestLaneSelectionResponse);
        CASE_STRING(k_EMsgServerToGCCavernCrawlIsHeroActive);
        CASE_STRING(k_EMsgServerToGCCavernCrawlIsHeroActiveResponse);
        CASE_STRING(k_EMsgClientToGCPlayerCardSpecificPurchaseRequest);
        CASE_STRING(k_EMsgClientToGCPlayerCardSpecificPurchaseResponse);
        CASE_STRING(k_EMsgGCtoServerTensorflowInstance);
        CASE_STRING(k_EMsgSQLSetIsLeagueAdmin);
        CASE_STRING(k_EMsgGCToGCGetLiveLeagueMatches);
        CASE_STRING(k_EMsgGCToGCGetLiveLeagueMatchesResponse);
        CASE_STRING(k_EMsgDOTALeagueInfoListAdminsRequest);
        CASE_STRING(k_EMsgDOTALeagueInfoListAdminsReponse);
        CASE_STRING(k_EMsgGCToGCLeagueMatchStarted);
        CASE_STRING(k_EMsgGCToGCLeagueMatchCompleted);
        CASE_STRING(k_EMsgGCToGCLeagueMatchStartedResponse);
        CASE_STRING(k_EMsgDOTALeagueNodeRequest);
        CASE_STRING(k_EMsgDOTALeagueNodeResponse);
        CASE_STRING(k_EMsgDOTALeagueAvailableLobbyNodesRequest);
        CASE_STRING(k_EMsgDOTALeagueAvailableLobbyNodes);
        CASE_STRING(k_EMsgGCToGCLeagueRequest);
        CASE_STRING(k_EMsgGCToGCLeagueResponse);
        CASE_STRING(k_EMsgGCToGCLeagueNodeGroupRequest);
        CASE_STRING(k_EMsgGCToGCLeagueNodeGroupResponse);
        CASE_STRING(k_EMsgGCToGCLeagueNodeRequest);
        CASE_STRING(k_EMsgGCToGCLeagueNodeResponse);
        CASE_STRING(k_EMsgGCToGCRealtimeStatsTerseRequest);
        CASE_STRING(k_EMsgGCToGCRealtimeStatsTerseResponse);
        CASE_STRING(k_EMsgGCToGCGetTopMatchesRequest);
        CASE_STRING(k_EMsgGCToGCGetTopMatchesResponse);
        CASE_STRING(k_EMsgClientToGCGetFilteredPlayers);
        CASE_STRING(k_EMsgGCToClientGetFilteredPlayersResponse);
        CASE_STRING(k_EMsgClientToGCRemoveFilteredPlayer);
        CASE_STRING(k_EMsgGCToClientRemoveFilteredPlayerResponse);
        CASE_STRING(k_EMsgGCToClientPlayerBeaconState);
        CASE_STRING(k_EMsgGCToClientPartyBeaconUpdate);
        CASE_STRING(k_EMsgGCToClientPartySearchInvite);
        CASE_STRING(k_EMsgClientToGCUpdatePartyBeacon);
        CASE_STRING(k_EMsgClientToGCRequestActiveBeaconParties);
        CASE_STRING(k_EMsgGCToClientRequestActiveBeaconPartiesResponse);
        CASE_STRING(k_EMsgClientToGCManageFavorites);
        CASE_STRING(k_EMsgGCToClientManageFavoritesResponse);
        CASE_STRING(k_EMsgClientToGCJoinPartyFromBeacon);
        CASE_STRING(k_EMsgGCToClientJoinPartyFromBeaconResponse);
        CASE_STRING(k_EMsgClientToGCGetFavoritePlayers);
        CASE_STRING(k_EMsgGCToClientGetFavoritePlayersResponse);
        CASE_STRING(k_EMsgClientToGCVerifyFavoritePlayers);
        CASE_STRING(k_EMsgGCToClientVerifyFavoritePlayersResponse);
        CASE_STRING(k_EMsgGCToClientPartySearchInvites);
        CASE_STRING(k_EMsgGCToClientRequestMMInfo);
        CASE_STRING(k_EMsgClientToGCMMInfo);
        CASE_STRING(k_EMsgGCDev_GrantWarKill);
        CASE_STRING(k_EMsgServerToGCLockCharmTrading);
        CASE_STRING(k_EMsgClientToGCPlayerStatsRequest);
        CASE_STRING(k_EMsgGCToClientPlayerStatsResponse);
        CASE_STRING(k_EMsgGCClearPracticeLobbyTeam);
        CASE_STRING(k_EMsgClientToGCFindTopSourceTVGames);
        CASE_STRING(k_EMsgGCToClientFindTopSourceTVGamesResponse);
        CASE_STRING(k_EMsgGCLobbyList);
        CASE_STRING(k_EMsgGCLobbyListResponse);
        CASE_STRING(k_EMsgGCPlayerStatsMatchSignOut);
        CASE_STRING(k_EMsgClientToGCCustomGamePlayerCountRequest);
        CASE_STRING(k_EMsgGCToClientCustomGamePlayerCountResponse);
        CASE_STRING(k_EMsgClientToGCSocialFeedPostCommentRequest);
        CASE_STRING(k_EMsgGCToClientSocialFeedPostCommentResponse);
        CASE_STRING(k_EMsgClientToGCCustomGamesFriendsPlayedRequest);
        CASE_STRING(k_EMsgGCToClientCustomGamesFriendsPlayedResponse);
        CASE_STRING(k_EMsgClientToGCFriendsPlayedCustomGameRequest);
        CASE_STRING(k_EMsgGCToClientFriendsPlayedCustomGameResponse);
        CASE_STRING(k_EMsgGCTopCustomGamesList);
        CASE_STRING(k_EMsgClientToGCSocialMatchPostCommentRequest);
        CASE_STRING(k_EMsgGCToClientSocialMatchPostCommentResponse);
        CASE_STRING(k_EMsgClientToGCSocialMatchDetailsRequest);
        CASE_STRING(k_EMsgGCToClientSocialMatchDetailsResponse);
        CASE_STRING(k_EMsgClientToGCSetPartyOpen);
        CASE_STRING(k_EMsgClientToGCMergePartyInvite);
        CASE_STRING(k_EMsgGCToClientMergeGroupInviteReply);
        CASE_STRING(k_EMsgClientToGCMergePartyResponse);
        CASE_STRING(k_EMsgGCToClientMergePartyResponseReply);
        CASE_STRING(k_EMsgClientToGCGetProfileCardStats);
        CASE_STRING(k_EMsgClientToGCGetProfileCardStatsResponse);
        CASE_STRING(k_EMsgClientToGCTopLeagueMatchesRequest);
        CASE_STRING(k_EMsgClientToGCTopFriendMatchesRequest);
        CASE_STRING(k_EMsgGCToClientProfileCardStatsUpdated);
        CASE_STRING(k_EMsgServerToGCRealtimeStats);
        CASE_STRING(k_EMsgGCToServerRealtimeStatsStartStop);
        CASE_STRING(k_EMsgGCToGCGetServersForClients);
        CASE_STRING(k_EMsgGCToGCGetServersForClientsResponse);
        CASE_STRING(k_EMsgGCPracticeLobbyKickFromTeam);
        CASE_STRING(k_EMsgDOTAChatGetMemberCount);
        CASE_STRING(k_EMsgDOTAChatGetMemberCountResponse);
        CASE_STRING(k_EMsgClientToGCSocialFeedPostMessageRequest);
        CASE_STRING(k_EMsgGCToClientSocialFeedPostMessageResponse);
        CASE_STRING(k_EMsgCustomGameListenServerStartedLoading);
        CASE_STRING(k_EMsgCustomGameClientFinishedLoading);
        CASE_STRING(k_EMsgGCPracticeLobbyCloseBroadcastChannel);
        CASE_STRING(k_EMsgGCStartFindingMatchResponse);
        CASE_STRING(k_EMsgSQLGCToGCGrantAccountFlag);
        CASE_STRING(k_EMsgGCToGCGetAccountFlags);
        CASE_STRING(k_EMsgGCToGCGetAccountFlagsResponse);
        CASE_STRING(k_EMsgSignOutWagerStats);
        CASE_STRING(k_EMsgGCToClientTopLeagueMatchesResponse);
        CASE_STRING(k_EMsgGCToClientTopFriendMatchesResponse);
        CASE_STRING(k_EMsgClientToGCMatchesMinimalRequest);
        CASE_STRING(k_EMsgClientToGCMatchesMinimalResponse);
        CASE_STRING(k_EMsgGCToGCGetProfileBadgePoints);
        CASE_STRING(k_EMsgGCToGCGetProfileBadgePointsResponse);
        CASE_STRING(k_EMsgGCToClientChatRegionsEnabled);
        CASE_STRING(k_EMsgClientToGCPingData);
        CASE_STRING(k_EMsgServerToGCMatchDetailsRequest);
        CASE_STRING(k_EMsgGCToServerMatchDetailsResponse);
        CASE_STRING(k_EMsgGCToGCEnsureAccountInParty);
        CASE_STRING(k_EMsgGCToGCEnsureAccountInPartyResponse);
        CASE_STRING(k_EMsgClientToGCGetProfileTickets);
        CASE_STRING(k_EMsgClientToGCGetProfileTicketsResponse);
        CASE_STRING(k_EMsgGCToClientMatchGroupsVersion);
        CASE_STRING(k_EMsgClientToGCH264Unsupported);
        CASE_STRING(k_EMsgClientToGCRequestH264Support);
        CASE_STRING(k_EMsgClientToGCGetQuestProgress);
        CASE_STRING(k_EMsgClientToGCGetQuestProgressResponse);
        CASE_STRING(k_EMsgSignOutXPCoins);
        CASE_STRING(k_EMsgGCToClientMatchSignedOut);
        CASE_STRING(k_EMsgGCGetHeroStatsHistory);
        CASE_STRING(k_EMsgGCGetHeroStatsHistoryResponse);
        CASE_STRING(k_EMsgClientToGCPrivateChatInvite);
        CASE_STRING(k_EMsgClientToGCPrivateChatKick);
        CASE_STRING(k_EMsgClientToGCPrivateChatPromote);
        CASE_STRING(k_EMsgClientToGCPrivateChatDemote);
        CASE_STRING(k_EMsgGCToClientPrivateChatResponse);
        CASE_STRING(k_EMsgClientToGCPrivateChatInfoRequest);
        CASE_STRING(k_EMsgGCToClientPrivateChatInfoResponse);
        CASE_STRING(k_EMsgClientToGCLatestConductScorecardRequest);
        CASE_STRING(k_EMsgClientToGCLatestConductScorecard);
        CASE_STRING(k_EMsgServerToGCPostMatchTip);
        CASE_STRING(k_EMsgServerToGCPostMatchTipResponse);
        CASE_STRING(k_EMsgClientToGCWageringRequest);
        CASE_STRING(k_EMsgGCToClientWageringResponse);
        CASE_STRING(k_EMsgClientToGCEventGoalsRequest);
        CASE_STRING(k_EMsgClientToGCEventGoalsResponse);
        CASE_STRING(k_EMsgClientToGCLeaguePredictions);
        CASE_STRING(k_EMsgGCToClientLeaguePredictionsResponse);
        CASE_STRING(k_EMsgGCToGCLeaguePredictionsUpdate);
        CASE_STRING(k_EMsgClientToGCSuspiciousActivity);
        CASE_STRING(k_EMsgGCToGCAddUserToPostGameChat);
        CASE_STRING(k_EMsgClientToGCHasPlayerVotedForMVP);
        CASE_STRING(k_EMsgClientToGCHasPlayerVotedForMVPResponse);
        CASE_STRING(k_EMsgClientToGCVoteForMVP);
        CASE_STRING(k_EMsgClientToGCVoteForMVPResponse);
        CASE_STRING(k_EMsgGCToGCGetEventOwnership);
        CASE_STRING(k_EMsgGCToGCGetEventOwnershipResponse);
        CASE_STRING(k_EMsgGCToClientAutomatedTournamentStateChange);
        CASE_STRING(k_EMsgClientToGCWeekendTourneyOpts);
        CASE_STRING(k_EMsgClientToGCWeekendTourneyOptsResponse);
        CASE_STRING(k_EMsgClientToGCWeekendTourneyLeave);
        CASE_STRING(k_EMsgClientToGCWeekendTourneyLeaveResponse);
        CASE_STRING(k_EMsgClientToGCTeammateStatsRequest);
        CASE_STRING(k_EMsgClientToGCTeammateStatsResponse);
        CASE_STRING(k_EMsgClientToGCGetGiftPermissions);
        CASE_STRING(k_EMsgClientToGCGetGiftPermissionsResponse);
        CASE_STRING(k_EMsgClientToGCVoteForArcana);
        CASE_STRING(k_EMsgClientToGCVoteForArcanaResponse);
        CASE_STRING(k_EMsgClientToGCRequestArcanaVotesRemaining);
        CASE_STRING(k_EMsgClientToGCRequestArcanaVotesRemainingResponse);
        CASE_STRING(k_EMsgGCTransferTeamAdminResponse);
        CASE_STRING(k_EMsgGCToClientTeamInfo);
        CASE_STRING(k_EMsgGCToClientTeamsInfo);
        CASE_STRING(k_EMsgClientToGCMyTeamInfoRequest);
        CASE_STRING(k_EMsgClientToGCPublishUserStat);
        CASE_STRING(k_EMsgGCToGCSignoutSpendWager);
        CASE_STRING(k_EMsgGCSubmitLobbyMVPVote);
        CASE_STRING(k_EMsgGCSubmitLobbyMVPVoteResponse);
        CASE_STRING(k_EMsgSignOutCommunityGoalProgress);
        CASE_STRING(k_EMsgGCToClientLobbyMVPNotifyRecipient);
        CASE_STRING(k_EMsgGCToClientLobbyMVPAwarded);
        CASE_STRING(k_EMsgGCToClientQuestProgressUpdated);
        CASE_STRING(k_EMsgGCToClientWageringUpdate);
        CASE_STRING(k_EMsgGCToClientArcanaVotesUpdate);
        CASE_STRING(k_EMsgClientToGCAddTI6TreeProgress);
        CASE_STRING(k_EMsgClientToGCSetSpectatorLobbyDetails);
        CASE_STRING(k_EMsgClientToGCSetSpectatorLobbyDetailsResponse);
        CASE_STRING(k_EMsgClientToGCCreateSpectatorLobby);
        CASE_STRING(k_EMsgClientToGCCreateSpectatorLobbyResponse);
        CASE_STRING(k_EMsgClientToGCSpectatorLobbyList);
        CASE_STRING(k_EMsgClientToGCSpectatorLobbyListResponse);
        CASE_STRING(k_EMsgSpectatorLobbyGameDetails);
        CASE_STRING(k_EMsgServerToGCCompendiumInGamePredictionResults);
        CASE_STRING(k_EMsgServerToGCCloseCompendiumInGamePredictionVoting);
        CASE_STRING(k_EMsgClientToGCOpenPlayerCardPack);
        CASE_STRING(k_EMsgClientToGCOpenPlayerCardPackResponse);
        CASE_STRING(k_EMsgClientToGCSelectCompendiumInGamePrediction);
        CASE_STRING(k_EMsgClientToGCSelectCompendiumInGamePredictionResponse);
        CASE_STRING(k_EMsgClientToGCWeekendTourneyGetPlayerStats);
        CASE_STRING(k_EMsgClientToGCWeekendTourneyGetPlayerStatsResponse);
        CASE_STRING(k_EMsgClientToGCRecyclePlayerCard);
        CASE_STRING(k_EMsgClientToGCRecyclePlayerCardResponse);
        CASE_STRING(k_EMsgClientToGCCreatePlayerCardPack);
        CASE_STRING(k_EMsgClientToGCCreatePlayerCardPackResponse);
        CASE_STRING(k_EMsgClientToGCGetPlayerCardRosterRequest);
        CASE_STRING(k_EMsgClientToGCGetPlayerCardRosterResponse);
        CASE_STRING(k_EMsgClientToGCSetPlayerCardRosterRequest);
        CASE_STRING(k_EMsgClientToGCSetPlayerCardRosterResponse);
        CASE_STRING(k_EMsgServerToGCCloseCompendiumInGamePredictionVotingResponse);
        CASE_STRING(k_EMsgServerToGCCompendiumInGamePredictionResultsResponse);
        CASE_STRING(k_EMsgLobbyBattleCupVictory);
        CASE_STRING(k_EMsgGCGetPlayerCardItemInfo);
        CASE_STRING(k_EMsgGCGetPlayerCardItemInfoResponse);
        CASE_STRING(k_EMsgClientToGCRequestSteamDatagramTicket);
        CASE_STRING(k_EMsgClientToGCRequestSteamDatagramTicketResponse);
        CASE_STRING(k_EMsgGCToClientBattlePassRollupRequest);
        CASE_STRING(k_EMsgGCToClientBattlePassRollupResponse);
        CASE_STRING(k_EMsgClientToGCTransferSeasonalMMRRequest);
        CASE_STRING(k_EMsgClientToGCTransferSeasonalMMRResponse);
        CASE_STRING(k_EMsgGCToGCPublicChatCommunicationBan);
        CASE_STRING(k_EMsgGCToGCUpdateAccountPublicChatBan);
        CASE_STRING(k_EMsgGCChatReportPublicSpam);
        CASE_STRING(k_EMsgClientToGCSetPartyBuilderOptions);
        CASE_STRING(k_EMsgClientToGCSetPartyBuilderOptionsResponse);
        CASE_STRING(k_EMsgGCToClientPlaytestStatus);
        CASE_STRING(k_EMsgClientToGCJoinPlaytest);
        CASE_STRING(k_EMsgClientToGCJoinPlaytestResponse);
        CASE_STRING(k_EMsgLobbyPlaytestDetails);
        CASE_STRING(k_EMsgDOTASetFavoriteTeam);
        CASE_STRING(k_EMsgGCToClientBattlePassRollupListRequest);
        CASE_STRING(k_EMsgGCToClientBattlePassRollupListResponse);
        CASE_STRING(k_EMsgGCIsProQuery);
        CASE_STRING(k_EMsgGCIsProResponse);
        CASE_STRING(k_EMsgDOTAClaimEventAction);
        CASE_STRING(k_EMsgDOTAClaimEventActionResponse);
        CASE_STRING(k_EMsgDOTAGetPeriodicResource);
        CASE_STRING(k_EMsgDOTAGetPeriodicResourceResponse);
        CASE_STRING(k_EMsgDOTAPeriodicResourceUpdated);
        CASE_STRING(k_EMsgServerToGCSpendWager);
        CASE_STRING(k_EMsgGCToGCSignoutSpendWagerToken);
        CASE_STRING(k_EMsgSubmitTriviaQuestionAnswer);
        CASE_STRING(k_EMsgSubmitTriviaQuestionAnswerResponse);
        CASE_STRING(k_EMsgClientToGCGiveTip);
        CASE_STRING(k_EMsgClientToGCGiveTipResponse);
        CASE_STRING(k_EMsgStartTriviaSession);
        CASE_STRING(k_EMsgStartTriviaSessionResponse);
        CASE_STRING(k_EMsgAnchorPhoneNumberRequest);
        CASE_STRING(k_EMsgAnchorPhoneNumberResponse);
        CASE_STRING(k_EMsgUnanchorPhoneNumberRequest);
        CASE_STRING(k_EMsgUnanchorPhoneNumberResponse);
        CASE_STRING(k_EMsgGCToClientTipNotification);
        CASE_STRING(k_EMsgClientToGCRequestSlarkGameResult);
        CASE_STRING(k_EMsgClientToGCRequestSlarkGameResultResponse);
        CASE_STRING(k_EMsgGCToGCSignoutSpendRankWager);
        CASE_STRING(k_EMsgGCToGCGetFavoriteTeam);
        CASE_STRING(k_EMsgGCToGCGetFavoriteTeamResponse);
        CASE_STRING(k_EMsgSignOutEventGameData);
        CASE_STRING(k_EMsgGCToClientAllStarVotesRequest);
        CASE_STRING(k_EMsgGCToClientAllStarVotesReply);
        CASE_STRING(k_EMsgGCToClientAllStarVotesSubmit);
        CASE_STRING(k_EMsgGCToClientAllStarVotesSubmitReply);
        CASE_STRING(k_EMsgClientToGCQuickStatsRequest);
        CASE_STRING(k_EMsgClientToGCQuickStatsResponse);
        CASE_STRING(k_EMsgGCToGCSubtractEventPointsFromUser);
        CASE_STRING(k_EMsgSelectionPriorityChoiceRequest);
        CASE_STRING(k_EMsgSelectionPriorityChoiceResponse);
        CASE_STRING(k_EMsgGCToGCCompendiumInGamePredictionResults);
        CASE_STRING(k_EMsgGameAutographReward);
        CASE_STRING(k_EMsgGameAutographRewardResponse);
        CASE_STRING(k_EMsgDestroyLobbyRequest);
        CASE_STRING(k_EMsgDestroyLobbyResponse);
        CASE_STRING(k_EMsgPurchaseItemWithEventPoints);
        CASE_STRING(k_EMsgPurchaseItemWithEventPointsResponse);
        CASE_STRING(k_EMsgServerToGCMatchPlayerItemPurchaseHistory);
        CASE_STRING(k_EMsgGCToGCGrantPlusHeroMatchResults);
        CASE_STRING(k_EMsgGCGetHeroTimedStats);
        CASE_STRING(k_EMsgGCGetHeroTimedStatsResponse);
        CASE_STRING(k_EMsgLobbyPlayerPlusSubscriptionData);
        CASE_STRING(k_EMsgServerToGCMatchStateHistory);
        CASE_STRING(k_EMsgPurchaseHeroRelic);
        CASE_STRING(k_EMsgPurchaseHeroRelicResponse);
        CASE_STRING(k_EMsgPurchaseHeroRandomRelic);
        CASE_STRING(k_EMsgPurchaseHeroRandomRelicResponse);
        CASE_STRING(k_EMsgClientToGCClaimEventActionUsingItem);
        CASE_STRING(k_EMsgClientToGCClaimEventActionUsingItemResponse);
        CASE_STRING(k_EMsgPartyReadyCheckRequest);
        CASE_STRING(k_EMsgPartyReadyCheckResponse);
        CASE_STRING(k_EMsgPartyReadyCheckAcknowledge);
        CASE_STRING(k_EMsgGetRecentPlayTimeFriendsRequest);
        CASE_STRING(k_EMsgGetRecentPlayTimeFriendsResponse);
        CASE_STRING(k_EMsgGCToClientCommendNotification);
        CASE_STRING(k_EMsgProfileRequest);
        CASE_STRING(k_EMsgProfileResponse);
        CASE_STRING(k_EMsgProfileUpdate);
        CASE_STRING(k_EMsgProfileUpdateResponse);
        CASE_STRING(k_EMsgSuccessfulHero);
        CASE_STRING(k_EMsgHeroGlobalDataRequest);
        CASE_STRING(k_EMsgHeroGlobalDataResponse);
        CASE_STRING(k_EMsgClientToGCRequestPlusWeeklyChallengeResult);
        CASE_STRING(k_EMsgClientToGCRequestPlusWeeklyChallengeResultResponse);
        CASE_STRING(k_EMsgGCToGCGrantPlusPrepaidTime);
        CASE_STRING(k_EMsgPrivateMetadataKeyRequest);
        CASE_STRING(k_EMsgPrivateMetadataKeyResponse);
        CASE_STRING(k_EMsgGCToGCReconcilePlusStatus);
        CASE_STRING(k_EMsgGCToGCCheckPlusStatus);
        CASE_STRING(k_EMsgGCToGCCheckPlusStatusResponse);
        CASE_STRING(k_EMsgGCToGCReconcilePlusAutoGrantItems);
        CASE_STRING(k_EMsgGCToGCReconcilePlusStatusUnreliable);
        CASE_STRING(k_EMsgActivatePlusFreeTrialRequest);
        CASE_STRING(k_EMsgActivatePlusFreeTrialResponse);
        CASE_STRING(k_EMsgGCToClientCavernCrawlMapPathCompleted);
        CASE_STRING(k_EMsgClientToGCCavernCrawlClaimRoom);
        CASE_STRING(k_EMsgClientToGCCavernCrawlClaimRoomResponse);
        CASE_STRING(k_EMsgClientToGCCavernCrawlUseItemOnRoom);
        CASE_STRING(k_EMsgClientToGCCavernCrawlUseItemOnRoomResponse);
        CASE_STRING(k_EMsgClientToGCCavernCrawlUseItemOnPath);
        CASE_STRING(k_EMsgClientToGCCavernCrawlUseItemOnPathResponse);
        CASE_STRING(k_EMsgClientToGCCavernCrawlRequestMapState);
        CASE_STRING(k_EMsgClientToGCCavernCrawlRequestMapStateResponse);
        CASE_STRING(k_EMsgSignOutTips);
        CASE_STRING(k_EMsgClientToGCRequestEventPointLogV2);
        CASE_STRING(k_EMsgClientToGCRequestEventPointLogResponseV2);
        CASE_STRING(k_EMsgClientToGCRequestEventTipsSummary);
        CASE_STRING(k_EMsgClientToGCRequestEventTipsSummaryResponse);
        CASE_STRING(k_EMsgHeroGlobalDataAllHeroes);
        CASE_STRING(k_EMsgClientToGCRequestSocialFeed);
        CASE_STRING(k_EMsgClientToGCRequestSocialFeedResponse);
        CASE_STRING(k_EMsgClientToGCRequestSocialFeedComments);
        CASE_STRING(k_EMsgClientToGCRequestSocialFeedCommentsResponse);
        CASE_STRING(k_EMsgClientToGCCavernCrawlGetClaimedRoomCount);
        CASE_STRING(k_EMsgClientToGCCavernCrawlGetClaimedRoomCountResponse);
        CASE_STRING(k_EMsgGCToGCReconcilePlusAutoGrantItemsUnreliable);
        CASE_STRING(k_EMsgServerToGCAddBroadcastTimelineEvent);
        CASE_STRING(k_EMsgGCToServerUpdateSteamBroadcasting);
        CASE_STRING(k_EMsgClientToGCRecordContestVote);
        CASE_STRING(k_EMsgGCToClientRecordContestVoteResponse);
        CASE_STRING(k_EMsgGCToGCGrantAutograph);
        CASE_STRING(k_EMsgGCToGCGrantAutographResponse);
        CASE_STRING(k_EMsgSignOutConsumableUsage);
        CASE_STRING(k_EMsgLobbyEventGameDetails);
        CASE_STRING(k_EMsgDevGrantEventPoints);
        CASE_STRING(k_EMsgDevGrantEventPointsResponse);
        CASE_STRING(k_EMsgDevGrantEventAction);
        CASE_STRING(k_EMsgDevGrantEventActionResponse);
        CASE_STRING(k_EMsgDevResetEventState);
        CASE_STRING(k_EMsgDevResetEventStateResponse);
        CASE_STRING(k_EMsgGCToGCReconcileEventOwnership);
        CASE_STRING(k_EMsgConsumeEventSupportGrantItem);
        CASE_STRING(k_EMsgConsumeEventSupportGrantItemResponse);
        CASE_STRING(k_EMsgGCToClientClaimEventActionUsingItemCompleted);
        CASE_STRING(k_EMsgGCToClientCavernCrawlMapUpdated);
        CASE_STRING(k_EMsgServerToGCRequestPlayerRecentAccomplishments);
        CASE_STRING(k_EMsgServerToGCRequestPlayerRecentAccomplishmentsResponse);
        CASE_STRING(k_EMsgClientToGCRequestPlayerRecentAccomplishments);
        CASE_STRING(k_EMsgClientToGCRequestPlayerRecentAccomplishmentsResponse);
        CASE_STRING(k_EMsgClientToGCRequestPlayerHeroRecentAccomplishments);
        CASE_STRING(k_EMsgClientToGCRequestPlayerHeroRecentAccomplishmentsResponse);
        CASE_STRING(k_EMsgSignOutEventActionGrants);
        CASE_STRING(k_EMsgClientToGCRequestPlayerCoachMatches);
        CASE_STRING(k_EMsgClientToGCRequestPlayerCoachMatchesResponse);
        CASE_STRING(k_EMsgClientToGCGetTicketCodesRequest);
        CASE_STRING(k_EMsgClientToGCGetTicketCodesResponse);
        CASE_STRING(k_EMsgClientToGCSubmitCoachTeammateRating);
        CASE_STRING(k_EMsgClientToGCSubmitCoachTeammateRatingResponse);
        CASE_STRING(k_EMsgGCToClientCoachTeammateRatingsChanged);
        CASE_STRING(k_EMsgClientToGCVoteForLeagueGameMVP);
        CASE_STRING(k_EMsgClientToGCRequestPlayerCoachMatch);
        CASE_STRING(k_EMsgClientToGCRequestPlayerCoachMatchResponse);
        CASE_STRING(k_EMsgClientToGCRequestContestVotes);
        CASE_STRING(k_EMsgClientToGCRequestContestVotesResponse);
        CASE_STRING(k_EMsgClientToGCMVPVoteTimeout);
        CASE_STRING(k_EMsgClientToGCMVPVoteTimeoutResponse);
        CASE_STRING(k_EMsgClientToGCGetUnderlordsCDKeyRequest);
        CASE_STRING(k_EMsgClientToGCGetUnderlordsCDKeyResponse);
        CASE_STRING(k_EMsgDetailedGameStats);
        CASE_STRING(k_EMsgClientToGCSetFavoriteAllStarPlayer);
        CASE_STRING(k_EMsgClientToGCSetFavoriteAllStarPlayerResponse);
        CASE_STRING(k_EMsgAllStarStats);
        CASE_STRING(k_EMsgClientToGCGetFavoriteAllStarPlayerRequest);
        CASE_STRING(k_EMsgClientToGCGetFavoriteAllStarPlayerResponse);
        CASE_STRING(k_EMsgClientToGCVerifyIntegrity);
        CASE_STRING(k_EMsgMatchMatchmakingStats);
        CASE_STRING(k_EMsgClientToGCSubmitPlayerMatchSurvey);
        CASE_STRING(k_EMsgClientToGCSubmitPlayerMatchSurveyResponse);
        CASE_STRING(k_EMsgSQLGCToGCGrantAllHeroProgressAccount);
        CASE_STRING(k_EMsgSQLGCToGCGrantAllHeroProgressVictory);
        CASE_STRING(k_eMsgGCToGCGetAllHeroCurrent);
        CASE_STRING(k_eMsgGCToGCGetAllHeroCurrentResponse);
        CASE_STRING(k_EMsgGCSubmitPlayerAvoidRequest);
        CASE_STRING(k_EMsgGCSubmitPlayerAvoidRequestResponse);
        CASE_STRING(k_EMsgGCToClientNotificationsUpdated);
        CASE_STRING(k_EMsgGCtoGCAssociatedExploiterAccountInfo);
        CASE_STRING(k_EMsgGCtoGCAssociatedExploiterAccountInfoResponse);
        default:
            return "Unknown message type(maybe new message).";
    }
}
