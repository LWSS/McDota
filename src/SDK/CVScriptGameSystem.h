...
public:
	...
	virtual void OnServerGamePostSimulate(void* const EventServerGamePostSimulate_t) = 0;
	virtual void OnClientGamePostSimulate(void* const EventClientGamePostSimulate_t) = 0;
	virtual void FrameBoundary(void* const EventGameFrameBoundary_t) = 0;
	virtual void OutOfGameFrameBoundary(void* const EventOutOfGameFrameBoundary_t) = 0;
	virtual void SaveGame(void* const EventSaveGame_t) = 0;
	virtual void RestoreGame(void* const EventRestoreGame_t) = 0;
